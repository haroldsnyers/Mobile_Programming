...
public class firstFragment extends Fragment {
    ...
    // the fragment_first initialization parameters, e.g. ARG_ITEM_NUMBER
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editTextFragment.setText(mParam1);
        editTextFragment.addTextChangedListener(new TextChangedListener<EditText>(editTextFragment) {
            @Override
